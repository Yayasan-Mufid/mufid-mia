...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card-group" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 1rem; margin-top: 200px">
                <div class="card p-4">
                    <center>
                        <img class="navbar-brand-full" src="https://mufid.or.id/wp-content/themes/yayasan-mufid/assets/images/mufid-logo.svg" width="150" alt="Honda" style="padding-top: 20px">
                    </center>
                    <div class="card-body">
